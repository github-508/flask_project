...
def file_upload():
    if request.method == 'POST':
        ...
        for f in files:
            upload_path = "../Resource/{}/datasrc/{}".format(user_name, f.filename)
...
def del_xlsx_csv_file():
    ...
    file_path = "../Resource/{}/datasrc/{}".format(user_name, file_name)
    os.remove(file_path)
...
def del_from_worksheet():
    if request.method == 'GET':
        user_name = request.args.get("name")
        file_name = request.args.get("file_name")
    file_path = "../Resource/{}/worksheet/{}.csv".format(user_name, file_name)
    os.remove(file_path)
    if not os.path.exists(file_path):
    ...
    if request.method == 'POST':
        ...
        for f in xlsx_list:
            ...
            if f[-1] == "v" or f[-1] == "s":
                ...
                csv_file_name = f[:-5]
            # print(csv_file_name)
            file_path_1 = "../Resource/{}/datasrc/{}".format(user_name, f)
            file_path_2 = "../Resource/{}/worksheet/{}.csv".format(user_name, csv_file_name)
            # print(csv_file_name)
            # print(file_path_2)
...
def add_file_process_platform():
    if request.method == 'POST':
        ...
        for f in csv_list:
            ...
            # csv_file_name = f.split(".")[0]
            # print(f)
            file_path_1 = "../Resource/{}/worksheet/{}.csv".format(user_name, f)
            file_path_2 = "../Resource/{}/processplatform/{}.csv".format(user_name, f)
            # print(file_path_2)
            if os.path.exists(file_path_2):
                return f + "文件已存在"
            if os.path.exists(file_path_1):
