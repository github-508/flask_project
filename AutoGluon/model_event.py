...
def fit_data(user_name, train_file, generate_model_name, industry, prediction_field, task_type, model_desc=None, features_list=None):
    ...
    train_file_path = "../Resource/{}/processplatform/{}.csv".format(user_name, train_file)
    save_path = "../Resource/{}/model/{}".format(user_name, generate_model_name)
...
def delete_model(user_name, delete_model_name):
    model_path = "../Resource/{}/model/{}".format(user_name, delete_model_name)
...
def load_model_for_csv(user_name, load_model_name, test_file, save_flag, new_file_name=None):
    model_path = "../Resource/{}/model/{}".format(user_name, load_model_name)
    test_file_path = "../Resource/{}/processplatform/{}.csv".format(user_name, test_file)
    if not os.path.exists(model_path):
        return "模型不存在"
