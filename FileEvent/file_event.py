...
def load_worksheet_file(user_name, load_file_name):
    file_path = "/home/wmy/Desktop/Resource/{}/worksheet/{}.csv".format(user_name, load_file_name)
...
def load_process_platform_file(user_name, load_file_name):
    file_path = "/home/wmy/Desktop/Resource/{}/processplatform/{}.csv".format(user_name, load_file_name)
    # df = pd.read_csv(file_path,  nrows=2000)
    df = pd.read_csv(file_path)
    # print(df)
    # print(df.to_json(orient='index'))
