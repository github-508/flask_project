...
def generate_report(user_name, visual_list=None, stat_list=None):
    ...
    for f in visual_list:
        visual_file_path = "/home/wmy/Desktop/Resource/{}/visual/{}.json".format(user_name, f)
        with open(visual_file_path) as file:
            json_ans = json.load(file)
            visual_ans_list.append(json_ans)
    for f in stat_list:
        stat_file_path = "/home/wmy/Desktop/Resource/{}/statistics/{}.json".format(user_name, f)
...
def save_report(user_name, file_name, report_ans):
    file_path = "/home/wmy/Desktop/Resource/{}/report/{}.json".format(user_name, file_name)
